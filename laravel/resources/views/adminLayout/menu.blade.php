        ...
        <ul class="sidebar-nav">
            ...
            <li class="sidebar-item">
                <a class="sidebar-link" href="ui-buttons.html">
                    <em class="align-middle" data-feather="file-text"></em> <span class="align-middle">Reporte
                        QHH</span>
                </a>
            </li>
            ...
            <li class="sidebar-item">
                <a class="sidebar-link" href="ui-forms.html">
                    <em class="align-middle" data-feather="users"></em> <span class="align-middle">Usuarios</span>
                </a>
            </li>
            ...
            <li class="sidebar-item">
                <a class="sidebar-link" href="ui-typography.html">
                    <em class="align-middle" data-feather="sliders"></em> <span
                        class="align-middle">Configuracion</span>
                </a>
            </li>

            <li class="sidebar-item">
                <a class="sidebar-link" href="icons-feather.html">
                    <em class="align-middle" data-feather="cpu"></em> <span class="align-middle">Pruebas del
                        sistema</span>
                </a>
            </li>
            ...
            <li class="sidebar-item">
                <a class="sidebar-link" href="icons-feather.html">
                    <em class="align-middle" data-feather="code"></em> <span class="align-middle">Logs</span>
                </a>
            </li>
