        ...
        <div class="container">
            ...
            <div class="block">
                <div class="row justify-content-center">
                    ...
                    <p class="text-center mb-5">Si quieres ser parte del equipo de especialistas médicos 
                            ...
                            <div class="col-lg-4">
                                <div class="service no-shadow align-items-center link horizontal d-flex active"
                                    ...
                                    <div class="service-contents">
                                        <p>Av. Esq. Blanca 501, Maipú, Región Metropolitana</p>
                        ...
                        <form action="{{ route('contactanos.store') }}" method="post">
                            ...
                            <div class="row">
                                <div class="col-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="nombre" class="form-control" id="fname" minlength="3" maxlength="20" required>
                                    </div>
                                </div>
                                <div class="col-6">
                                    <div class="form-group">
                                        <label class="text-black" for="lname">Apellido</label>
                                        <input type="text" name="apellido" class="form-control" id="lname" minlength="3" maxlength="20" required>
                                    </div>
                                </div>
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group mb-5">
                                ...
                                <textarea name="mensaje" class="form-control" id="message" cols="30" rows="5" minlength="15" maxlength="1000" required></textarea> 
                            </div>
